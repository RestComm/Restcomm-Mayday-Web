...
(function () {
  ...
  var defaultConfiguration = {
	//console.log("Creating defaultConfigurations....");
    ...
    toolName: "VerizonCoBrowsingTool",
  ...
  var baseUrl = window.location.protocol+"//"+window.location.host+"/MayDay";
 //var baseUrl = "https://togetherjs.com";
 // var baseUrl = window.location.protocol+"//"+window.location.host+"/verizon";
  ...
  var TogetherJS = window.TogetherJS = function TogetherJS(event) {
    console.log("Initializing TogetherJS object.");
	...
	console.log("Startup button not mentioned.");
	}
    } catch (e) {
  ...
  function onload() {
	console.log("TogetherJS onload");
    if (TogetherJS.startup._joinShareId) {
	console.log("Found SessionId. Joining Session.");
      TogetherJS();
	...
	console.log("SessionId not found.");
      ...
      if (value) {
	console.log("Got sessionId from storage variable -> togetherjs-session.status");
	...
	console.log("Initializing together js...");
        TogetherJS.startup.reason = "joined";
        TogetherJS();
      }else{
	console.log("TogetherJS AutoStart not set.. not starting session.");
	}
    }
  }
